...
const Edit = () => {
  ...
  return (
    <div>
      ...
      <input
        id="street"
        value={personToAddEddit.address.street}
        onChange={handleChange}
      ...
      <input
        id="city"
        value={personToAddEddit.address.city}
        onChange={handleChange}
      ...
      <input
        id="zip"
        value={personToAddEddit.address.zip}
        onChange={handleChange}
        placeholder="Add zip"
      ></input>
      <br />
      <input
        id="name"
        value={personToAddEddit.hobbies.name}
        onChange={handleChange}
      ...
      <input
        id="description"
        value={personToAddEddit.hobbies.description}
        onChange={handleChange}
